#!/usr/bin/env python3
"""
Demonstração do Sistema Global de Predições
...
class GlobalPredictionsDemo:
    """Demo do sistema global de predições"""
    ...
    def generate_global_matches(self, num_matches=12):
        """Gera partidas globais simuladas"""
    ...
    def run_demo(self):
        """Executa demonstração do sistema global"""
        print("🌍 DEMONSTRAÇÃO DO SISTEMA GLOBAL - MARABET AI")
        print("=" * 80)
        
        # 1. Gerar partidas globais
        global_matches = self.generate_global_matches(12)
        ...
        # 4. Salvar predições
        try:
            with open('global_predictions_demo.txt', 'w', encoding='utf-8') as f:
                f.write(output)
            print("\n✅ Predições salvas em: global_predictions_demo.txt")
        except Exception as e:
            print(f"\n❌ Erro ao salvar predições: {e}")
        
        # 5. Mostrar características do sistema
        print("\n🌍 CARACTERÍSTICAS DO SISTEMA GLOBAL:")
        print("=" * 60)
        
        features = [
            "✅ Cobertura global das principais ligas",
            ...
            "✅ Predições para partidas futuras e ao vivo",
