...
MaraBet AI - Envia predições diretamente para o Telegram
"""
...
def run_telegram_direct():
    """Executa envio direto via Telegram"""
    print("🚀 ENVIO DIRETO VIA TELEGRAM - MARABET AI")
    print("=" * 60)
    ...
    try:
        ...
        international_matches = demo.generate_international_matches(15)
        ...
        if success:
            ...
            try:
                with open('telegram_predictions_sent.txt', 'w', encoding='utf-8') as f:
                    f.write(message)
                print("✅ Predições salvas em: telegram_predictions_sent.txt")
            except Exception as e:
