...
# Comandos para configurar backup no servidor Ubuntu
...
(crontab -l 2>/dev/null; echo "0 2 * * * /home/ubuntu/backup.sh >> /var/log/marabet_backup.log 2>&1") | crontab -
...
echo "📝 Log: /var/log/marabet_backup.log"
