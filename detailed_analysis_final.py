#!/usr/bin/env python3
"""
Sistema de Predições Detalhadas com Análise de Valor Esperado - Formato Final Correto
Funciona com o formato real das predições (categorias -> listas de objetos)
"""
...
class DetailedPredictionAnalyzer:
    ...
    def get_market_odds(self, market_type: str, selection: str) -> float:
        ...
        odds_mapping = {
            ...
            'clean_sheet': {
                'Casa': 3.20, 'Visitante': 4.50, 'Nenhum': 1.25
            },
            'asian_handicap': {
    ...
    def analyze_all_predictions(self, predictions: Dict) -> List[Dict]:
        ...
        for category, pred_list in predictions.items():
            if isinstance(pred_list, list):
                for prediction in pred_list:
                    ...
                    detailed_analysis['category'] = category
                    all_analyses.append(detailed_analysis)
