...
Versão de demonstração que funciona sem configuração manual
"""
...
def main():
    notifier = TelegramNotifierDemo()
    
    print("🎯 MARABET AI - SISTEMA DE NOTIFICAÇÕES TELEGRAM (DEMO)")
    print("=" * 60)
    
    print("\n📋 OPÇÕES:")
    print("1. Simular envio de predições")
    print("2. Gerar mensagens para envio manual")
    print("3. Mostrar predições disponíveis")
